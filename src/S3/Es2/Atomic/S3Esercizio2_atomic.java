...
class Sensore implements Runnable {
    ...
    public void run() {
        while (!isSuperato) {
            if (soglia < S3Esercizio2_atomic.contatore.get()) {
                System.out.println("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
                System.out.println("Sensore" + id + " - Soglia superata.");
                System.out.println("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
                S3Esercizio2_atomic.contatore.set(0);
                isSuperato = true;
            }
        }
    }
...
public class S3Esercizio2_atomic {
    ...
    public static void main(String[] args) {
        ...
        while (S3Esercizio2_atomic.contatore.get() <= 120) {

            final int n = ThreadLocalRandom.current().nextInt(1, 9);
            S3Esercizio2_atomic.contatore.getAndAdd(n);
            System.out.println("VALORE CONTATORE: " + S3Esercizio2_atomic.contatore);
