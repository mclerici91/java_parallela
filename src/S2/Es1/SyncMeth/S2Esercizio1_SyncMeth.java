...
class Autostrada {
    ...
    // Versione con un metodo synchronized, si potrebbe sviluppare anche con 3 metodi distinti (addEntrata, addUscita e addPedaggio)
...
class Automobilista implements Runnable {
    ...
    public void run() {
        ...
        for (int i = 0; i < 500; i++) {
            ...
            autostrada.travel(pedaggioTratta);
...
public class S2Esercizio1_SyncMeth {
